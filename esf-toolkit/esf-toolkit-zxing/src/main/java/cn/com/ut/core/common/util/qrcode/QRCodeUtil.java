package cn.com.ut.core.common.util.qrcode;
...
public class QRCodeUtil {
	...
	public static void encode(String content, String imgPath, String destPath, boolean needCompress)
		...
		mkdirs(destPath);
		String file = destPath + "/" + CommonUtil.getUUID() + ".jpg";
	 ...
	 * @throws Exception
	 */
	public static InputStream encodeAsStream(String content, String imgPath, boolean needCompress)
			throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		// text="http://t.cn/h1jGSC";
		text = "http://t.cn/MFbMfi";
		text = "http://t.cn/Rwvv4AS";
		// QRCodeUtil.encode(text, "D:/image/back.jpg", "D:/image/qrcode/",
		// true);
		// encodeAsStream(text, null, false);
		encode(text, new FileOutputStream("F://aaa.jpg"));
	}
}
