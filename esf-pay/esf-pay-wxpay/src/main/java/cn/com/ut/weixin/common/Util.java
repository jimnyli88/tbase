...
public class Util {
	...
	public static String toXmlString(Object obj) {
		...
		setFiel(obj.getClass(), xStreamForRequestPostData);
		setFiel(obj.getClass().getSuperclass(), xStreamForRequestPostData);
	...
	public static Object getObjectFromXML(String xml, Class tClass) {
		...
		setFiel(tClass, xStreamForResponseData);
		return xStreamForResponseData.fromXML(xml);
	}

	private static void setFiel(Class tClass, XStream xStreamForResponseData) {

		Field[] fields = tClass.getDeclaredFields();
		for (Field field : fields) {
			WeiXinField ano = field.getAnnotation(WeiXinField.class);
			if (ano != null) {
				xStreamForResponseData.aliasField(ano.value(), tClass, field.getName());
			}
		}
	}
