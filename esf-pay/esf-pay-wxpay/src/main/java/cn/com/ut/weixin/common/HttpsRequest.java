...
import cn.com.ut.weixin.service.IServiceRequest;
...
public class HttpsRequest implements IServiceRequest {
	...
	private void init() throws IOException, KeyStoreException, UnrecoverableKeyException,
		...
		if (isUseSSL) {
			...
			bulider.setSSLSocketFactory(sslsf);
		}

		httpClient = bulider.build();
	...
	public String sendPost(String url, ModuleBase xmlObj) throws IOException, KeyStoreException,
		...
		String postDataXML = Util.toXmlString(xmlObj);
